...
\begin{figure}[ht!]
        ...
        \caption{iOS Software Updates\cite{Apple[7]} \protect\footnotemark}
        	\label{fig:iOS Software Updates}
\end{figure}
\footnotetext{Eigenwerk}
Seit der Veröffentlichung der ersten iOS Version im Jahr 2007 wurden insgesamt 79 Softwareupdates von Apple bereitgestellt. Darunter befinden sich neun Major-Updates und 70  Minor-Updates (siehe Abb. \ref{fig:iOS Software Updates}).
\begin{figure}[hb!]
        \centering
...
%\label{sec:JBStep1}
%Im ersten Schritt muss ein Bug im iOS und/oder einer Applikation gefunden werden, welcher es erlaubt \glqq die Sandbox\grqq{} (siehe e: \ref{sec:Sandbox}) zu umgehen. 
