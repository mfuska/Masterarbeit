...
\begin{description}
    ...
    \begin{enumerate}
        ...
        \item iPhone 4 - keine Coprozessor mit Secure Enclave
        \item iPhone 4s - keine Coprozessor mit Secure Enclave
        \item iPhone 5 - keine Coprozessor mit Secure Enclave
        \item iPhone 5c - keine Coprozessor mit Secure Enclave
    \end{enumerate}
\end{description} 
