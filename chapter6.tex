...
Apple schloss in der iOS Version 9.0 zweiundsiebzig Sicherheitslücken und das JB-Team Pangu benötigte 28 Tage um diese Version zu \textit{\glqq jailbreaken\grqq{}}. Die iOS Version 9.2 beendete nach \textbf{55 Tagen} die Funktionsfähigkeit des JB-Tools Pangu9 .
...
Die Daten zeigen, dass die Hypothese H1: (siehe Kapitel: \ref{sec:GQMHypothese}) nicht bestätigt werden kann. Die Anzahl an Tagen die für ein JB benötigt werden, hängen von zu vielen anderen Faktoren ab. 
...
\begin{description}
   ...
   \end{enumerate}
\end{description} 
Diese Faktoren können nicht aus den Daten extrahiert werden, und deshalb kann die Hypothese nicht bestätigt werden.
