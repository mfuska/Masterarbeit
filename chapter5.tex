...
Die Signatur der App wird von der AMFI Kernel Extension (siehe Kap. \ref{sec:AMFI}) geprüft, und es wird sichergestellt, dass nur ein valider Code vom Prozessor ausgeführt wird.    
