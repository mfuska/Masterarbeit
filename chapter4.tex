...
\begin{figure}[htb]
  ...
  Der Sicherheitsmechanismus des iOS Device unterteilt sich in zwei Ebenen. 
  		\begin{description}
			...
			\end{enumerate}
   		\end{description}
Die iOS Sicherheit basiert auf einer Kombination von Software, Hardware und Diensten, welches ein Maximum an Sicherheit garantieren soll (vgl. \cite{Apple[4]} S.4).
	\end{minipage}
	\hfil
