...
\begin{table*}[htbp]
    \begin{center}
      \begin{tabular}{p{3cm}p{12cm}} 
        ...
        \textbf{Backdoor} & Als Backdoor wird die Möglichkeit bezeichnet, dass ein User unter Umgehung der normalen Zugriffssicherung, Zugang zum iOS Device erhält.\\
		...
		\textbf{Framework} & Ein Framework ist ein Programmiergerüst, das in der  Softwareentwicklung Verwendung findet. \\
